! Module containing the nbdirsmax and nbdirsmax0 variables required by speelpenning_dv_dv
module diffsizes
  implicit none
...
! Include the forward-upon-forward mode derivative generated by Tapenade
